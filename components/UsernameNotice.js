  ...
  return (
    <div className='username-confirm'>
      ...
      <div className='username-confirm-subtitle'>
        This update will be applied to all <b>future</b> gratitudes as well as your personal page address. Previous gratitudes will not be affected.
      </div>
      <div className='username-confirm-input-wrapper'>
        <FormInput
          ...
          prefix={
            <div className='username-confirm-domain'>
              SimpleGratitudes.com/
          </div>
          }
        />
