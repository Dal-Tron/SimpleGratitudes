...
export const MainMenu = ({ closeMenu = () => {}, signOut = () => {}, visible = false }) => {
  ...
  return (
    <div
      className={`sg-menu-item-container ${
        visible ? "sg-menu-item-container-open" : ""
      }`}
    >
      <span onClick={() => handleClick("username")} className="sg-menu-item">
        <div className="sg-menu-item-text">{username || "Gratitudes"}</div>
        <div
          className={`sg-menu-item-icon ${
            router.route === "/[page]" ? "sg-menu-item-icon-selected" : ""
          }`}
        >
          <UserOutlined />
        </div>
      ...
      <span onClick={() => handleClick("home")} className="sg-menu-item">
        ...
        <div
          className={`sg-menu-item-icon ${
            router.route === "/" ? "sg-menu-item-icon-selected" : ""
          }`}
        >
          <StarOutlined />
        </div>
      ...
      <span onClick={() => handleClick("settings")} className="sg-menu-item">
        ...
        <div
          className={`sg-menu-item-icon ${
            router.route === "/settings" ? "sg-menu-item-icon-selected" : ""
          }`}
        >
          <SettingOutlined />
        </div>
