...
/*!******************!*\
  !*** ./store.js ***!
  \******************/
/*! exports provided: actionTypes, reducer, addGratitude, removeGratitude, saveGratitude, initializeStore */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveGratitude", function() { return saveGratitude; });
...
var defaultGratitude = {
  gratitude: ""
};
var initialState = {
  gratitudes: [defaultGratitude]
};
var actionTypes = {
...
var addGratitude = function addGratitude() {
  return {
    type: actionTypes.ADD_GRATITUDE,
    defaultGratitude: defaultGratitude
  };
};
...
var saveGratitude = function saveGratitude(gratitude) {
  return;
};
...
//# sourceMappingURL=index.js.5843a1c25ebf51535973.hot-update.js.map