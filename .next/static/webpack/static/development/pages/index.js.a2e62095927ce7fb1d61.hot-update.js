  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          db = _context.sent;
          quotes = db.firestore().collection('quotes').get(); // db.firestore().collection('quotes').get().then(querySnapshot => {
...
//# sourceMappingURL=index.js.a2e62095927ce7fb1d61.hot-update.js.map