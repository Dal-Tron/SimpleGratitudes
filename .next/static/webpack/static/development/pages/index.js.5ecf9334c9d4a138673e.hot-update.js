...
var time = new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_1___default()()).toTimeString().slice(9);
var actionTypes = {
  TICK: 'TICK' // REDUCERS
...
var setClock = function setClock() {
  return {
    ...
    ts: new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_1___default()()).toTimeString()
  };
};
...
//# sourceMappingURL=index.js.5ecf9334c9d4a138673e.hot-update.js.map