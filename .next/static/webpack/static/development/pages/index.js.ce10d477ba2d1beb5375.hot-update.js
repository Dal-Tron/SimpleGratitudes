  ...
  switch (action.type) {
    case actionTypes.ADD_GRATITUDE:
      return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, state, {
        gratitudes: _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, state.gratitudes, gratitude)
      });

    case actionTypes.UPDATE_GRATITUDE:
      state.gratitudes[action.gratitude.id] = action.gratitude.gratitude;
      return state;
...
var addGratitude = function addGratitude(gratitudeValue) {
  var gratitudeID = "gratitude-".concat(generateUniqueID());
  var gratitude = createGratitude(gratitudeID, gratitudeValue);
  return {
...
var updateGratitude = function updateGratitude(id, gratitudeText) {
  var gratitude = createGratitude(id, gratitudeText);
  return {
...
var createGratitude = function createGratitude(id, value) {
  var gratitude = {};
  gratitude[id] = value;
  return gratitude;
};
...
//# sourceMappingURL=index.js.ce10d477ba2d1beb5375.hot-update.js.map